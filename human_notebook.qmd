...
Nous rejetons H0 et nous pouvons dire que l'activité physique diffère de manière significative entre le hommes et les femmes au seuil α de 5% (test de Welch, *t* = 2,62, ddl = 129,8, valeur *p* = 0,0049).
