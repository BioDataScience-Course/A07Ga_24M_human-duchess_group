...
Nous ne rejetons pas H₀ et nous ne pouvons pas conclure que la valeur de l'IMC dépend significativement de la consommation d au seuil α de 5% (Chi carré d'indépendance, ddl = 6, valeur *p* = 0,3282).
