...
biometry <- smutate(biometry,
  RTH_rec = case_when(
    genre == "H" & RTH >= 1 ~ "risque élevé",
    genre == "H" & RTH >= 0.95 ~ "risque modéré",
    genre == "H" & RTH < 0.95 ~ "risque faible",
    genre == "F" & RTH >= 0.9 ~ "risque élevé",
    genre == "F" & RTH >= 0.8 ~ "risque modéré",
    genre == "F" & RTH < 0.8 ~ "risque faible"
  ))
