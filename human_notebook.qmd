...
Nous ne rejetons pas H₀ et nous ne pouvons pas conclure que la valeur de l'IMC dépend significativement de la consommation d au seuil α de 5% (Chi^2^ d'indépendance, ddl = 6, valeur *p* = 0,3282).
...
residus_std <- rstandard(biometry_anova2)

ggplot(data.frame(residus_std), aes(sample = residus_std)) +
  stat_qq() +
  stat_qq_line(color = "black") +
  labs(title = "Graphique quantile-quantile des résidus - biometry_anova2",
