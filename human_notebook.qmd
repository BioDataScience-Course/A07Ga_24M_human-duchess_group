...
Nous ne rejetons pas H₀ et nous ne pouvons pas dire que le nombre de cigarettes fumées par semaine diffère de manière significative du nombre de verres d'alcool consommés par semaine au seuil α de 5% (test *t*  apparié, *t* = 0.47906, ddl = 143, valeur *p* = 0,6326).
...
Nous ne rejetons pas H₀. Donc, nous ne pouvons pas conclure que la taille est significativement différente au seuil α de 5 % , que ce soit en fonction de l'IMC (*F* = 1,28, ddl = 3 et 137, valeur *p* = 0,284) ou de la consommation de fast food (*F* = 1,62, ddl = 2 et 137, valeur *p* = 0,203).
