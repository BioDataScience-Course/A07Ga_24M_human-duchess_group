...
biometry$IMC_cat_rec <- biometry$IMC_cat %>%
  fct_recode(
    "Obésité sévère à morbide" = "Obésité sévère (Grade II)",
    "Obésité sévère à morbide" = "Obésité morbide (Grade III)",
    "Obésité sévère à morbide" = "Super-obésité (Obésité massive)"
  )
```
...
anova(lm(biometry, activite_physique ~ age_rec_rec)) |> tabularise()
```
