...
biometry %>.%
  sgroup_by(., genre) %>.%
  ssummarise(.,
    moyenne = fmean(sommeil),
    variance = fvar(sommeil),
    n = fn(sommeil)) -> Camille_tab2
Camille_tab2
```

<!-- Hypothèse nulle et alternative -->

HO : moyenne sommeil femme - moyenne sommeil homme = 0

H1 : moyenne sommeil femme - moyenne sommeil homme != 0

<!-- Vérification des conditions d'application -->

```{r test_t_1 Camille et Alexia}
t.test(data = biometry, sommeil ~ genre,
